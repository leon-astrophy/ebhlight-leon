...
bhl.config.set_rparm("dt", "double", default=1.0e-6)
bhl.config.set_rparm("Rout", "double", default=20.0)
bhl.config.set_rparm("Rout_rad", "double", default=20.0)
bhl.config.set_rparm("gam", "double", default=5.0 / 3.0)
bhl.config.set_rparm("DTd", "double", default=5.0)
bhl.config.set_rparm("DTl", "double", default=5.0e-1)
bhl.config.set_rparm("DTr", "double", default=1000000.0)
bhl.config.set_rparm("DNr", "integer", default=1000000)
bhl.config.set_rparm("a", "double", default=0.0)
bhl.config.set_rparm("mbh", "double", default=1.0)
bhl.config.set_rparm("M_unit", "double", default=1.989e27)
bhl.config.set_rparm("tune_emiss", "double", 1.0e-5)
...
bhl.config.set_rparm("BHflux", "double", default=0.0)
bhl.config.set_rparm("beta", "double", default=100.0)
bhl.config.set_rparm("numin_emiss", "double", default=1.0e16)
bhl.config.set_rparm("numax_emiss", "double", default=1.0e26)
bhl.config.set_rparm("numin_spec", "double", default=1.0e10)
bhl.config.set_rparm("numax_spec", "double", default=1.0e25)
bhl.config.set_rparm("tp_over_te", "double", default=1)
bhl.config.set_rparm("nph_per_proc", "double", default=1.0e6)
